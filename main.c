...
void set_Clock(void)
{
    ...
    unsigned char seconds_l = seconds;
    unsigned char minutes_l = minutes;
    unsigned char hours_l = hours;
    unsigned char amPm_l= amPm;
    unsigned char date_l = date;
    unsigned char month_l = month;
    unsigned char year_l = year;
    ...
    while (set == false) {
        ...
        if (selection == 0) { //to set seconds in time
            ...
            if ('1' == userCommand[1] && '5' == userCommand[2] && '8' == userCommand[3]) {
                ...
                display_time(seconds_l, minutes_l, hours_l, amPm, date_l, month_l, year_l)
            }
